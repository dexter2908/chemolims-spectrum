...
angular.module('app.test').directive('datatableBasic', function ($compile) {
    return {
        restrict: 'A',
        scope: {
            tableOptions: '='
        ...
        link: function (scope, element, attributes) {
            ...
            var options = {
                ...
                "preDrawCallback": function () {
                    ...
                    if (!this.smartResponsiveHelper && typeof ResponsiveDatatablesHelper !== 'undefined') {
            ...
            scope.$watch('tableOptions.data', function(newData) {
                if (newData) {
                    if (_dataTable) {
                        _dataTable.clear();
                        _dataTable.rows.add(newData);
                        _dataTable.draw();
                    }
                }
            }, true);
